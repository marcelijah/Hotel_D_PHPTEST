<?php 
// Session starten, um auf Login-Status zugreifen zu können
session_start(); 
?>
<!DOCTYPE html>
<html lang="de">
    ...
    <div class="container EA-Team-container my-5">
        ...
        <div class="row align-items-center mb-5 EA-Team1">
            ...
            <div class="col-md-6 team-image">
                <img src="assets/img/Arian.jpg" alt="Foto von Arian" class="img-fluid rounded shadow">
            </div>
        </div>

        <div class="row align-items-center mb-5 EA-Team2">
            <div class="col-md-6 team-image">
                <img src="assets/img/Elijah.jpg" alt="Foto von Elijah" class="img-fluid rounded shadow">
            </div>
            <div class="col-md-6 team-textbox">
    ...
    <div class="container Lage-container my-5">
        <div class="row Lage-content align-items-center">
            ...
            <div class="col-md-6 Lage-image">
                <img src="assets/img/Location_img1.jpg" alt="Foto von der Lage" class="img-fluid rounded shadow">
            </div>
        </div>
    </div>
