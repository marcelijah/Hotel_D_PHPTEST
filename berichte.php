...
<main class="container py-5">
    <h2 class="text-center mb-4">Auslastung & Berichte</h2>
    <p class="text-center">Hier sehen Sie eine Übersicht über belegte Zimmer und die Hotel-Auslastung.</p>

    <div class="card shadow-sm p-4 text-center berichte-box">
        <h5>Auslastung anzeigen</h5>
        <a href="#" class="btn-admin d-block mx-auto">Berichte anzeigen</a>
    </div>
</main>
